...
@export var slow_duration = 1.0 #Время полета с половинной скоростью
@export var acceleration_duration = 1.0 #Время разгона до полной скорости после замедления
@export_range(-1.0, 1.0, 0.01) var acceleration_curve = -0.5 #Кривая разгона
